...
@section('content')
        ...
        <div class="w-full relative mt-12">
            <div class="swiper multiple-slide-carousel">
                <div class="swiper-wrapper">
                    @foreach($dashboardMovies['recentMovies'] as $recentMovie)
                        <div class="swiper-slide">
                            <div class="bg-indigo-50 rounded-2xl h-96 flex justify-center items-center">
                                <span class="text-2xl font-semibold text-indigo-600">{{ $recentMovie->title }}</span>
                            </div>
                        </div>
                    @endforeach
                </div>
    ...
    <div class="w-full relative mt-12">
        <div class="swiper multiple-slide-carousel">
            <div class="swiper-wrapper">
                @foreach($dashboardMovies['goodRatingMovies'] as $goodRatingMovie)
                    <div class="swiper-slide">
                        <div class="bg-indigo-50 rounded-2xl h-96 flex justify-center items-center">
                            <span class="text-2xl font-semibold text-indigo-600">{{ $goodRatingMovie->title }}</span>
                        </div>
                    </div>
                @endforeach
            </div>
